...
const ManageUsers = () => {
    ...
    const handleAdmin = user =>{
        fetch(`https://summer-camp-learning-school-server-evo264714.vercel.app/users/admin/${user._id}`,{
            method: 'PATCH'
        })
        .then(res => res.json())
        .then(data =>{
    ...
    const handleInstructor = user =>{
        fetch(`https://summer-camp-learning-school-server-evo264714.vercel.app/users/instructor/${user._id}`,{
            method: 'PATCH'
        })
        .then(res => res.json())
        .then(data =>{
